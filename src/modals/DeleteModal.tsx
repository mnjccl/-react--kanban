...
function DeleteModal({
  ...
  return (
    <div
      className="fixed right-0 bottom-0 left-0 top-0 px-2 py-2 overflow-scroll scrollbar-hide z-50 justify-center items-center flex bg-[#00000080]"
      onClick={(e) => {
    ...
    >
      <div className="scrollbar-hide overflow-y-scroll max-w-md max-h-[95vh] my-auto bg-white dark:bg-[#2b2c37] text-black dark:text-white w-full px-8 py-8 rounded-xl">
        ...
        {type === "task" ? (
          ...
          <p className="text-gray-500 font-semibold  tracking-wide text-sm pt-6">
            {`Are you sure you want to delete the "${title}" board? This action will rmeove all columns and tasks and can't be reversed.`}
          </p>
        )}
        ...
        <div className="flex w-full mt-4 items-center justify-center space-x-4">
          ...
          <button
            ...
            className="w-full items-centerhover:opacity-75 font-semibold bg-[#635fc71a] text-[#635fc7] py-2 rounded-full"
          >
            Cancel
          </button>
        </div>
